    ...
    return (
        <AppLayout>
            <div className="module-shell expenses-workspace">
                ...
                <div className="module-actions"><BulkImport label="Bulk upload" tableColumns={['Date', 'Expense #', 'Description', 'Category', 'Vendor', 'Amount', 'Tax', 'Total', 'Payment', 'Account', 'Status']} /></div>
                {activeTab === 'Expenses' && <>
